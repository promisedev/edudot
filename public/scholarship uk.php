...
$statement = $pdo->prepare("SELECT * FROM scholarship WHERE country = 'uk' ORDER BY create_date DESC ");
$statement->execute();
...
<div class="slide_item"style="background:url('../src/icons/kenturkey.png');background-repeat: no-repeat;
