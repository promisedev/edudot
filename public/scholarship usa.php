...
$statement = $pdo->prepare("SELECT * FROM scholarship WHERE country = 'usa' ORDER BY create_date DESC ");
$statement->execute();
...
2</div>
<!--  -->
<div class="slide_item"style="background:url('../src/icons/havard.png');background-repeat: no-repeat;
     ; background-size: 100% 100%;">
2</div>
<!--  -->
