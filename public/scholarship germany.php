...
$statement = $pdo->prepare("SELECT * FROM scholarship WHERE country = 'germany' ORDER BY create_date DESC ");
$statement->execute();
...
<div class="slide_item"style="background:url('../src/icons/hamborg.png');background-repeat: no-repeat;
...
2</div>
<!--  -->
<div class="slide_item"style="background:url('../src/icons/dorhamans.png');background-repeat: no-repeat;
     ; background-size: 100% 100%;">
2</div>
<!--  -->
</div>
